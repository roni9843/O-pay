...
import { Landmark, Plus, Loader2, Building, Upload, ArrowLeft } from 'lucide-react';
        ...
        <div className="relative z-10 flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-slate-400 max-w-xl">
               Create a new supported bank configuration.
            </p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
           ...
           <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {saving ? <Loader2 className="w-6 h-6 animate-spin" /> : 'Save Bank'}
              </button>
           </form>
        </motion.div>
